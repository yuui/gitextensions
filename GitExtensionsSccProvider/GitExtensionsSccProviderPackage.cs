// VsPkg.cs : Implementation of GitExtensionsSccProvider
//
...
namespace Henk.GitExtensionsSccProvider
{
    ...
    [ProvideLoadKey("Standard", "1.0", "GitExtensions Source Control Provider", "Henk", 1)]
    ...
    public sealed class GitExtensionsSccProviderPackage : Package
    {
        ...
        /// </summary>
        public GitExtensionsSccProviderPackage()
        {
        ...
        private GitSourceControlProvider sccService = null;
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidGitExtensionsSccProviderCmdSet, (int)PkgCmdIDList.cmdidCommit);
                MenuCommand menuItem = new MenuCommand(MenuItemCallback, menuCommandID );
                mcs.AddCommand( menuItem );
                // Create the command for the tool window
                CommandID toolwndCommandID = new CommandID(GuidList.guidGitExtensionsSccProviderCmdSet, (int)PkgCmdIDList.cmdidGitExtensions);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            Microsoft.VisualStudio.ErrorHandler.ThrowOnFailure(uiShell.ShowMessageBox(
                       0,
                       ref clsid,
                       "Git Extensions Source Control Provider",
