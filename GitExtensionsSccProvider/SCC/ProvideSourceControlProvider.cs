...
namespace Henk.GitExtensionsSccProvider
{
    ...
    public class ProvideSourceControlProvider : RegistrationAttribute
    {
        ...
        {
            get { return GuidList.guidGitExtensionsSccProviderPkg; }
        }
        ...
        {
            context.RemoveKey("SourceControlProviders\\" + GuidList.guidGitExtensionsSccProviderPkg.ToString("B"));
        }
    }
}
